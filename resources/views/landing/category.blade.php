...
<section class="servis my-5" id="servis">
    <div class="container">
        <div class="row">
            ...
            <div class="owl-servis owl-carousel owl-theme owl-lazy">
                @foreach ($pakets as $paket)
                    <button type="button" class="border-0 bg-white text-dark"
                        data-bs-target="#myModalServis-{{ $loop->iteration }}" data-bs-toggle="modal">
                        <div class="item">
                            <div class="card border-0 mx-1 my-3" onmouseover="onMouseOver(this)"
                                onmouseout="onMouseOut(this)">
                                <div class="mt-3 mx-3">
                                    <img src="{{ asset('storage/images/paket/'.$paket->image_url) }}" class="card-img-top rounded" alt="...">
                                </div>
            ...
            @foreach ($pakets as $paket)
                <div class="modal" id="myModalServis-{{ $loop->iteration }}">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <button type="button" class="btn bg-white border-0 text-uppercase fw-bold"
                                    data-bs-dismiss="modal"><i class="fas fa-arrow-left"></i> servis</button>
